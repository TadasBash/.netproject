...
namespace NamuD
{
    public partial class PriorityStatusForm : Form
    {
        ...
        public PriorityStatusForm(Class1 dataHandler)
        {
            this.dataHandler = dataHandler;
            tasks = dataHandler.LoadTasks(); //load tasks from the file to ensure updated data
        ...
        private void InitializeCustomComponents()
        {
            ...
            LoadTasksIntoComboBox(); // Load tasks into the combo box
            ...
            statusComboBox.Items.AddRange(new[] { "Not Started", "In Progress" });
        ...
        {
            // Clear existing items and reload tasks
            taskComboBox.Items.Clear();
            tasks = dataHandler.LoadTasks(); // Reload tasks from file
            taskComboBox.Items.AddRange(tasks.Select(t => t.TaskName).ToArray());
            taskComboBox.SelectedIndex = -1; // Reset selection
        }

        private void RefreshButton_Click(object sender, EventArgs e)
        {
            LoadTasksIntoComboBox();
            MessageBox.Show("Tasks refreshed successfully!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            LoadTasksIntoComboBox(); // Reload tasks to reflect updates
        }
    }
}
